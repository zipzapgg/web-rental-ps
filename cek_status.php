...
<head>
  ...
  <style>
    ...
    .alert-rate{background:rgba(239,68,68,.1);border:1px solid rgba(239,68,68,.3);border-radius:10px;padding:.9rem 1.1rem;color:#f87171;font-family:var(--font-ui);font-size:.88rem;margin-bottom:1.5rem;}
...
?>
  <div class="result-card" style="margin-bottom:1rem;">
    ...
    <div style="padding:1rem 1.5rem;">
      <a href="https://wa.me/<?php echo $wa_admin; ?>?text=<?php echo $pesan; ?>" target="_blank" rel="noopener noreferrer" style="display:inline-flex;align-items:center;gap:.5rem;text-decoration:none;font-family:var(--font-ui);font-size:.82rem;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:#25d366;background:rgba(37,211,102,.1);border:1px solid rgba(37,211,102,.3);padding:.5rem 1rem;border-radius:8px;transition:background .2s;" onmouseover="this.style.background='rgba(37,211,102,.2)'" onmouseout="this.style.background='rgba(37,211,102,.1)'">
