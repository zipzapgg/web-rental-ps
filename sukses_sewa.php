...
<head>
  ...
  <style>
    ...
    .cek-step{display:flex;gap:.75rem;align-items:flex-start;font-size:.85rem;color:var(--v-muted);font-family:var(--font-body);line-height:1.6;margin-bottom:.75rem;}
  ...
  <div class="sukses-card">
    ...
    <div class="cek-box">
      <div style="display:flex;align-items:center;gap:.5rem;margin-bottom:1rem;">
        <svg width="16" height="16" style="color:#60a5fa;flex-shrink:0;"><use href="#ico-search"/></svg>
      ...
      <div class="cek-step">
        ...
        <div>Status pengajuanmu akan tampil:
          <div style="display:flex;align-items:center;gap:.5rem;margin-top:.4rem;flex-wrap:wrap;">
            <span style="background:rgba(251,191,36,.15);color:#fbbf24;border:1px solid rgba(251,191,36,.3);font-family:var(--font-ui);font-size:.78rem;font-weight:700;padding:.2rem .65rem;border-radius:20px;">Pending</span>
            <span style="color:var(--v-muted);font-size:.8rem;">→</span>
            <span style="background:rgba(16,185,129,.15);color:#34d399;border:1px solid rgba(16,185,129,.3);font-family:var(--font-ui);font-size:.78rem;font-weight:700;padding:.2rem .65rem;border-radius:20px;">Disetujui</span>
            <span style="color:var(--v-muted);font-size:.8rem;">→</span>
            <span style="background:rgba(96,165,250,.15);color:#60a5fa;border:1px solid rgba(96,165,250,.3);font-family:var(--font-ui);font-size:.78rem;font-weight:700;padding:.2rem .65rem;border-radius:20px;">Selesai</span>
          </div>
        </div>
      </div>
    </div>
